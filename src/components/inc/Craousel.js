      ...
      <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <img src={car5} className="d-block w-100" alt="First slide" style={carouselImageStyle} />
          ...
          <div className="carousel-item">
            <img src={car2} className="d-block w-100" alt="Fifth slide" style={carouselImageStyle} />
            <div className="carousel-caption d-none d-md-block">
        ...
        <button className="carousel-control-next text-black" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
